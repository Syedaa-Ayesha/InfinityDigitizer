    ...
    >
      <div className="max-w-330  px-4 mx-28.25">
        ...
        <div className="relative mt-14">
          ...
          <button className="custom-prev absolute -left-6 top-1/2 z-30 flex h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full bg-white shadow-xl">
            <ChevronLeft />
          </button>
          ...
          <button className="custom-next absolute -right-6 top-1/2 z-30 flex h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full bg-white shadow-xl">
            <ChevronRight />
          </button>
        </div>
      ...
      <section className="bg-[#46546A] py-10">
        <div className="max-w-330 mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4">
            ...
            ${
              index !== features.length - 1 ? "xl:border-r border-white/15" : ""
            }
          `}
              >
                {/* Icon */}
                ...
                <div className="flex h-13.5 w-13.5 shrink-0 items-center justify-center rounded-full bg-white">
                  <div className="text-[#7434E5]">{item.icon}</div>
                </div>
