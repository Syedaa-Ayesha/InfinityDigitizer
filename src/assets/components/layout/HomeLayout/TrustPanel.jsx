        ...
        <div className="flex items-center">
          {[...Array(5)].map((_, index) => (
            <Star
              key={index}
              size={22}
              className="fill-[#FE9E0C] text-[#FE9E0C]  text-base "
              strokeWidth={1}
            />
          ))}
          <span className="text-black ml-1 font-semibold text-xs lg:text-base">5.0</span>
        </div>

        <p className="font-semibold text-black text-xs lg:text-base">
