...
const ProcessCard = ({
  ...
  return (
     <div className="relative lg:w-fit h-55 rounded-[20px] bg-white border border-[#E6E1EF] px-7 py-3  flex items-center " 
      style={{
    boxShadow:
      ...
      <div className="flex items-center gap-3">
        ...
        {/* Icon */}
        <div className="w-18 h-18 lg:w-22 lg:h-22 rounded-[16px] bg-[#F3EFFA] flex items-center justify-center text-[#7434E5] shrink-0">
          {icon}
        </div>

        {/* Content */}
        <div className="lg:w-62 lg:h-[134px]">
